...
<?php if (!isset($this->session->userdata['name']) && $this->session->userdata['is_admin'] == FALSE ): ?>
...
<?php else: ?>
	<nav class="navbar navbar-expand-lg bg-black flex-end">
  <div class="container-fluid">
    <a class="navbar-brand text-white" href="<?php echo base_url()?>index.php/admin">SOCCER TICKETS</a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse  justify-content-end" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active text-white" aria-current="page" href="<?php echo base_url()?>index.php/admin">Home</a>
        </li>
				<li class="nav-item">
          <a class="nav-link text-white" href="<?php echo base_url()?>index.php/admin/contact	Manage">List Feedback</a>
        </li>
				<li class="nav-item">
          <a class="nav-link text-white" href="<?php echo base_url()?>index.php/admin/tiketManage">List Tiket</a>
        </li>
			<li class="nav-item">
          <a class="nav-link text-white" href="<?php echo base_url()?>index.php/admin/PesananManage">List Pesanan</a>
        </li>
				<li class="nav-item">
